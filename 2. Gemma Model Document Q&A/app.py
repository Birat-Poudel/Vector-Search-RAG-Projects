...
from langchain_community.vectorstores import FAISS # Vactor Store DB
...
prompt = ChatPromptTemplate.from_template(
    ...
    Pleasse provide the most accurate response based on the question
    <context>
    {context}
    <context>
    Question: {input}
...
prompt1 = st.text_input("Ask your documents?")
